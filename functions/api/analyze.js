...
.contacto-detail {
  font-size: 14px; color: rgba(180,200,218,0.65); line-height: 1.7;
}
.contacto-detail a { color: rgba(180,200,218,0.65); transition: color 0.2s; }
  ...
  <div class="container">
    ...
    <div class="mirada-layout fade-up delay-1">
      ...
      <div class="mirada-body">
        <p>En el ámbito educativo, muchas veces la selección de docentes se reduce a la búsqueda de candidatos disponibles para cubrir una vacante. <strong>Nuestro trabajo va mucho más allá de eso.</strong></p>
        <p>Las plataformas pueden facilitar la difusión de vacantes y el acceso a perfiles. Nuestro aporte es diferente: conocer y comprender el proyecto educativo e institucional, y acompañar en la construcción de equipos docentes coherentes que logren alinearse con ese proyecto.</p>
        <p>Esto implica mirar más allá de la trayectoria y la biografía del docente, para considerar también:</p>
        <div class="mirada-dimensions">
          ...
          <div class="dim-item">
            ...
            <span class="dim-text"><strong>Las dinámicas de los equipos</strong> existentes y cómo la incorporación los afectará.</span>
          </div>
          <div class="dim-item">
            <span class="dim-num">04</span>
            <span class="dim-text"><strong>El tipo de vínculos</strong> que la institución busca construir con su comunidad educativa.</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="problema-grid fade-up delay-2">
      <div class="problema-card">
        ...
        <p class="pcard-text">La búsqueda recae sobre quienes ya tienen múltiples responsabilidades, con poco tiempo disponible y criterios que se construyen caso por caso.</p>
      </div>
      <div class="problema-card">
        <div class="pcard-num">02</div>
        <h3 class="pcard-title">Búsqueda por recomendación</h3>
        <p class="pcard-text">Las redes informales y los contactos personales son el canal habitual. Funcionan a veces, pero difícilmente garantizan el perfil institucional preciso que cada escuela necesita.</p>
      </div>
      <div class="problema-card">
        <div class="pcard-num">03</div>
        <h3 class="pcard-title">El encaje tiene consecuencias reales</h3>
        <p class="pcard-text">Cada incorporación impacta en el aula y en el equipo. Cuando la búsqueda se prolonga o el perfil es inadecuado, lo sienten los estudiantes primero.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="dif-grid fade-up delay-1">
      <div class="dif-card">
        ...
        <p class="dcard-text">Qué tipo de docente necesita esta institución, en función de su propuesta educativa específica. El perfil surge del proyecto — no del CV más disponible.</p>
      </div>
      <div class="dif-card">
        <div class="dcard-num">02</div>
        <h3 class="dcard-title">Equipo existente</h3>
        <p class="dcard-text">Quién va a trabajar junto a quién y cómo eso afecta la dinámica y la cultura del equipo docente. La incorporación es siempre un acto relacional.</p>
      </div>
      <div class="dif-card">
        <div class="dcard-num">03</div>
        <h3 class="dcard-title">Cultura institucional</h3>
        <p class="dcard-text">Los valores, el estilo y la misión que distinguen a esa institución y que deben sostenerse en cada incorporación.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="steps" style="position:relative;">
      ...
      <div class="step fade-up delay-1">
        ...
        <p class="step-text">Conversación diagnóstica con el equipo directivo para conocer la institución en profundidad.</p>
      </div>
      <div class="step fade-up delay-2">
        <div class="step-circle">2</div>
        <h3 class="step-title">Definición del perfil</h3>
        <p class="step-text">Trabajamos juntos en la definición del perfil docente: formación, competencias y capacidad de integración.</p>
      </div>
      <div class="step fade-up delay-3">
        <div class="step-circle">3</div>
        <h3 class="step-title">Búsqueda y evaluación</h3>
        <p class="step-text">Difusión en canales especializados, análisis de antecedentes, entrevistas con foco pedagógico e institucional.</p>
      </div>
      <div class="step fade-up delay-4">
        <div class="step-circle">4</div>
        <h3 class="step-title">Presentación de candidatos</h3>
        <p class="step-text">Terna evaluada con informe de fit institucional de cada candidato/a para facilitar una decisión informada.</p>
      </div>
      <div class="step fade-up delay-5">
        <div class="step-circle">5</div>
        <h3 class="step-title">Acompañamiento e integración</h3>
        <p class="step-text">Acompañamos la decisión final y, cuando es requerido, orientamos la integración al equipo institucional.</p>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="areas-layout fade-up delay-1">
      <div class="areas-text">
        <p>Acompañamos a instituciones educativas en procesos de identificación, evaluación e incorporación de profesionales docentes o afines que puedan integrarse de manera coherente a su proyecto pedagógico y al trabajo colectivo del equipo.</p>
        <p>Nuestro enfoque reconoce que el trabajo educativo es una <strong>práctica situada</strong>, profundamente vinculada a la cultura institucional. Por eso, los procesos de evaluación contemplan tanto los antecedentes profesionales como la manera en que cada profesional concibe la enseñanza, el trabajo con colegas y el vínculo con estudiantes y familias.</p>
        <p>Cada proceso se desarrolla de manera situada, atendiendo a las características de la institución y al perfil específico del cargo.</p>
      </div>
...
<section id="equipo">
  ...
  <img src="foto-alejandra.jpeg" alt="Alejandra Rolón" style="width:100%; height:100%; object-fit:cover;">
        ...
        <p class="persona-bio">Licenciada en Sociología por la Universidad de Buenos Aires, con más de veinte años de experiencia en selección y headhunting de perfiles profesionales en distintos sectores. Actualmente se dedica al acompañamiento en desarrollo profesional, empleabilidad y construcción de trayectorias laborales, integrando una mirada sociológica sobre el trabajo y las organizaciones.</p>
      ...
      <div class="persona-card fade-up delay-3">
        <div class="persona-initial">M</div>
        <h3 class="persona-name">María Inés Solé</h3>
        <p class="persona-role">Educación y gestión institucional</p>
        <div class="persona-rule"></div>
        <p class="persona-bio">Con más de cuarenta años de trayectoria en el ámbito educativo, desarrolló su carrera en distintos roles dentro del sistema, incluyendo funciones de supervisión. Es Técnica en Liderazgo Ontológico y Coach Ontológico Profesional Certificada (PCC) por la International Coaching Federation.</p>
        <div class="persona-tags">
  ...
  <div class="container">
    <div class="fade-up">
      <h2 class="contacto-headline">
        Construir equipos docentes<br>
        <em>empieza por una conversación.</em>
      </h2>
      <p class="contacto-sub">Si tienen una vacante docente activa o anticipan que tendrán una, este es un buen momento para hablar.</p>
    </div>
    <div class="contacto-cards fade-up delay-1">
      <a href="https://wa.me/5491100000000?text=Hola%20D%26D%2C%20me%20interesa%20conocer%20m%C3%A1s%20sobre%20el%20servicio" class="contacto-card" target="_blank">
        ...
        <div class="contacto-detail">
          <a href="/cdn-cgi/l/email-protection#c3a2afa6a9a2ada7b1a283a7baa7eda0acaeeda2b1"><span class="__cf_email__" data-cfemail="22434e4748434c46504362465b460c414d4f0c4350">[email&#160;protected]</span></a><br>
          <a href="https://wa.me/5491100000000" target="_blank">WhatsApp →</a>
        </div>
      </a>
      <a href="https://wa.me/5491100000001?text=Hola%20D%26D%2C%20me%20interesa%20conocer%20m%C3%A1s%20sobre%20el%20servicio" class="contacto-card" target="_blank">
        ...
        <div class="contacto-detail">
          <a href="/cdn-cgi/l/email-protection#650804170c040c0b001625011c014b060a084b0417"><span class="__cf_email__" data-cfemail="375a56455e565e59524477534e531954585a195645">[email&#160;protected]</span></a><br>
          <a href="https://wa.me/5491100000001" target="_blank">WhatsApp →</a>
        </div>
      </a>
    </div>
